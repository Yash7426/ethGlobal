...
const envVarsSchema = joi_1.default.object()
    ...
    PORT: joi_1.default.number().default(5000).description('Port to run the server'),
    // JWT
    ...
    RECLAIM_APP_ID: joi_1.default.string().required().description("Reclaim APP Id"),
    RECLAIM_APP_SECRET_KEY: joi_1.default.string().required().description("Reclaim Secret Key"),
})
    .unknown();
